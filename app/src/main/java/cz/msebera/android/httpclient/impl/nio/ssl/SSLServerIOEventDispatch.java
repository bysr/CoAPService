...
package cz.msebera.android.httpclient.impl.nio.ssl;

import javax.net.ssl.SSLContext;
import javax.net.ssl.SSLException;

import cz.msebera.android.httpclient.annotation.Immutable;
import cz.msebera.android.httpclient.impl.nio.DefaultServerIOEventDispatch;
import cz.msebera.android.httpclient.impl.nio.reactor.SSLIOSession;
import cz.msebera.android.httpclient.impl.nio.reactor.SSLSetupHandler;
...
/**
 * Default implementation of {@link cz.msebera.android.httpclient.nio.reactor.IOEventDispatch}
 * interface for SSL (encrypted) server-side HTTP connections.
 *
 * @since 4.1
 *
 * @deprecated (4.2) use {@link cz.msebera.android.httpclient.impl.nio.DefaultHttpServerIODispatch}
 */
@Deprecated
