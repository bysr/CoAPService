...
package cz.msebera.android.httpclient.impl.nio.reactor;
 ...
 * @since 4.0
 *
 * @deprecated (4.2) use {@link cz.msebera.android.httpclient.nio.reactor.ssl.SSLIOSession}
 */
@Deprecated
public class SSLIOSession extends cz.msebera.android.httpclient.nio.reactor.ssl.SSLIOSession {
    ...
    public SSLIOSession(
        ...
        super(session, cz.msebera.android.httpclient.nio.reactor.ssl.SSLMode.CLIENT,
    ...
    public synchronized void bind(
        ...
        final cz.msebera.android.httpclient.nio.reactor.ssl.SSLSetupHandler handler = getSSLSetupHandler();
    ...
    private cz.msebera.android.httpclient.nio.reactor.ssl.SSLMode convert(final SSLMode mode) {
        switch(mode) {
        case CLIENT:
            return cz.msebera.android.httpclient.nio.reactor.ssl.SSLMode.CLIENT;
        case SERVER:
            return cz.msebera.android.httpclient.nio.reactor.ssl.SSLMode.SERVER;
        }
        return null;
    }
