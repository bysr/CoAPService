...
public interface NHttpRequestExecutionHandler {
     ...
     *
     * @see cz.msebera.android.httpclient.nio.reactor.ConnectingIOReactor#connect
     *
     ...
     * instance of {@link cz.msebera.android.httpclient.nio.entity.ProducingNHttpEntity}.
     *
     * @param context the actual HTTP context
